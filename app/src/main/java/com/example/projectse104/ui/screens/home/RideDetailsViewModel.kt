...
class RideDetailsViewModel @Inject constructor(
    private val getRideDetailsHistoryUseCase: GetRideDetailsHistoryUseCase,
    savedStateHandle: SavedStateHandle
) : ViewModel() {

    private val _rideState =
        MutableStateFlow<Response<RideWithUserWithLocation>>(Response.Loading)
    ...
    fun getRideDetails(rideId: String) {
        ...
        getRideDetailsHistoryUseCase(rideId)
            .onEach { result ->
